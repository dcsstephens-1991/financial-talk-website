...
const TRANSLATIONS = {
  en: {
    ...
    contact: {
      ...
      social: {
        title: "Follow along",
        body: "Replace the links below with your partner's real social profiles.",
      },
      note: "This is a placeholder page — swap in a real booking link or contact form when you're ready to launch.",
    },
    footer: {
  ...
  es: {
    ...
    contact: {
      ...
      social: {
        title: "Síguenos",
        body: "Reemplaza los enlaces de abajo con los perfiles sociales reales.",
      },
      note: "Esta es una página de ejemplo — agrega un enlace real de reservas o un formulario de contacto antes de lanzar el sitio.",
    },
    footer: {
